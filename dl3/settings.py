"""
Django settings for dl3 project.
...
SECRET_KEY = "django-insecure-^=risw+ft^#9%$w(-sz91y-p(mgol##_p0^2+9am@x&br3wt*!"
...
WSGI_APPLICATION = "dl3.wsgi.application"
